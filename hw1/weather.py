...
parser.add_argument("-l", default="hsinchu" ,type=str ,help="locations" , metavar="location" )
parser.add_argument("-u", default="c" ,type=str , choices=['c','f'] ,help="unit", metavar="unit" )
...
group.add_argument("-d", type=int , choices=[1,2,3,4,5] , help="forecasr" , metavar="day")
